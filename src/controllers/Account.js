...
module.exports = {
    ...
    async statement(req, res, next){
        ...
        try {
            ...
            let accountStatement = await repositoryAccount.getStatement(req.params.accountNumber, parseInt(req.params.filter));
    ...
    async statementInput(req, res, next){
        ...
        try {
            let accountStatementInput = await repositoryAccount.getStatementInput(req.params.accountNumber, parseInt(req.params.filter));
    ...
    async statementOutput(req, res, next){
        ...
        try {
            ...
            let accountStatementOutput = await repositoryAccount.getStatementOutput(req.params.accountNumber, parseInt(req.params.filter));
